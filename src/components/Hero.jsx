    ...
    <div className='Hero' style={{display:"flex"}}>
      ...
      <div className='Hero_Details'>
        ...
        <div className="icon-buttons">
          <p>Visit at: </p>
          <a href="https://github.com/reyes-ro" className="icon-btn github" target="_blank" aria-label="GitHub">
          ...
          <a href="https://www.linkedin.com/in/ronald-reyes-014a22268/" className="icon-btn linkedin" target="_blank" aria-label="LinkedIn">
            <svg viewBox="0 0 24 24" fill="currentColor">
          ...
          <a href="https://www.facebook.com/ronald.a.reyes.361103" className="icon-btn facebook" target="_blank" aria-label="Facebook">
            <svg viewBox="0 0 24 24" fill="currentColor">
